...
const personalProjects: Project[] = [
  ...
  },
  {
    ...
    description:
      "8-key, 2 rotary encoder, Arduino Pro Micro macropad in a 3D printed enclosure, built as an early proof of concept for open, customizable accessibility-focused controllers.",
    ...
    details: [
        ...
        { type: "text", content: "The hardware is simple on purpose: 8 keyboard switches and two KY040 rotart encoders, wired to an Arduino Pro Micro inside a 3D printed enclosure. It was also my first real experience with soldering, 3D printing, and writing Arduino code, so a lot of the project was me learning the basics by building something I could actually use." },
        { type: "text", content: "The larger idea was to make a baseline design that could be opened up and modified. Different people have different accessibility needs, especially for gaming controllers, and I wanted the controller to be something someone could change for their own preferences. Things like position, reach, feedback strength, or preferred layout without needing a closed-source product." },
        { type: "text", content: "The code treats the board like a standard USB keyboard for easy plug-n-play. Each of the 8 switches is assigned to a function key from F13 to F20 by default, and the rotary encoders are programmed with brightness and volume control, which keeps the keys out of the way of normal keyboard shortcuts. Those assignments can be changed directly in the code depending on what the user needs." },
