...
const teamProjects: Project[] = [
  ...
  },
  {
    ...
    details:
      "Owned the propulsion subsystem end-to-end: motor mount tube, centering rings, composite boat tail, thrust plate, and a threaded crown for external motor retention. Coordinated machining and composites scheduling against the team's launch deadline.\n\nResults at Launch Canada 2025: 8th place nationally, 16,500 ft apogee, and the Spirit Bear Award for team conduct and collaboration.",
  },
  {
  ...
  },
  {
    ...
    details:
      "48-hour hackathon project using the NASA Exoplanet Archive. Built a map-first interface for exploring exoplanets with filters across mass, radius, orbital period, and discovery method.\n\nMy role was product framing and dataset curation — picking which fields actually told a story and writing accessibility-first explainers so non-astronomers could navigate the data.",
  },
];
